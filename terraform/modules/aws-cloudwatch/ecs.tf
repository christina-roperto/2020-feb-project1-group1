resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  alarm_name          = "${var.project_name}-ECSService-CPUUtilization-High"
  alarm_description   = "${var.project_name} scale-out pushed by cpu-utilization"
...
resource "aws_cloudwatch_metric_alarm" "cpu_low" {
  alarm_name          = "${var.project_name}-ECSService-CPUUtilization-Low"
  alarm_description   = "${var.project_name} scale-in pushed by cpu-utilization"
